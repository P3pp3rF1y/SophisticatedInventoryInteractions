...
public class InventoryInteractionSortMemory extends SavedData {
	...
	private static final SavedDataType<InventoryInteractionSortMemory> TYPE = new SavedDataType<>(
			Identifier.fromNamespaceAndPath(SophisticatedInventoryInteractions.MOD_ID, "sort_memory"), InventoryInteractionSortMemory::new,
