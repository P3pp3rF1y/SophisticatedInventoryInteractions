...
import net.p3pp3rf1y.sophisticatedinventoryinteractions.client.InventoryInteractionsTranslationHelper;
...
public class Config {
	...
	public static class Common {
		...
		public Common(ModConfigSpec.Builder builder) {
			...
			forceIncludeMenuClasses = defineStringList(builder, "forceInclude.menuClasses", InventoryInteractionsTranslationHelper.INSTANCE.translConfig("forceInclude.menuClasses"), List.of());
			excludeMenuClasses = defineStringList(builder, "exclude.menuClasses", InventoryInteractionsTranslationHelper.INSTANCE.translConfig("exclude.menuClasses"), List.of());
			includeMenuClasses = defineStringList(builder, "include.menuClasses", InventoryInteractionsTranslationHelper.INSTANCE.translConfig("include.menuClasses"), List.of());
			safeMenuClasses = defineStringList(builder, "safeList.menuClasses", InventoryInteractionsTranslationHelper.INSTANCE.translConfig("safeList.menuClasses"), List.of(
			...
			menuSlotExclusions = defineStringList(builder, "slotExclusions.menuSlotOverrides", InventoryInteractionsTranslationHelper.INSTANCE.translConfig("slotExclusions.menuSlotOverrides"), List.of(
			...
			anchorOffsetOverrides = defineStringList(builder, "layout.anchorOffsetOverrides", InventoryInteractionsTranslationHelper.INSTANCE.translConfig("layout.anchorOffsetOverrides"), List.of(
					"net.minecraft.client.gui.screens.inventory.DispenserScreen=54,0"
			));
			builder.pop();
		}

		private ModConfigSpec.ConfigValue<List<? extends String>> defineStringList(ModConfigSpec.Builder builder, String key, String translationKey, List<String> defaults) {
	...
	public static class Client {
		...
		public Client(ModConfigSpec.Builder builder) {
			...
			rememberSearchPhrase = builder.comment("Whether search phrase is remembered and shared between Sophisticated and non-Sophisticated container screens")
					.translation(InventoryInteractionsTranslationHelper.INSTANCE.translConfig("rememberSearchPhrase"))
